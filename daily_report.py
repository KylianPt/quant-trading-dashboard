...
from data_single_asset import get_price_history
from strategies_single import backtest_buy_and_hold, backtest_momentum_sma
from metrics import summarize_strategy, annualized_volatility


# Choisis ici les actifs du report (sous-liste CAC 40 + CAC index)
ASSET_TICKERS = [
    "^FCHI",   # CAC 40 index
    "AI.PA",   # Air Liquide
    "MC.PA",   # LVMH
